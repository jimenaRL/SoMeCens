python scripts/demographs_creation/create_demograph.py --country=czechia --metadatayear=2020 && \
python scripts/demographs_creation/create_demograph.py --country=czechia --metadatayear=2023 && \
